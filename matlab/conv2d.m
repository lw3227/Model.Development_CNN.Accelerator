...
img_input = imread('./images/paper_200_v1_test_1590.png') ;
img = img_input ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%detect and transform the imag/%%%%%%%%%%%%%%%%%%%
%检测input img的通道数，转grey

%img = imresize(img_grey, [64 64]);
img = int8(double(img) - 128);   % Convert to signed int8
